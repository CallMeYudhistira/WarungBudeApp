...
<div class="mt-3 p-4" style="border: 1px solid #ccc; border-radius: 12px; padding: 12px;">
    <form action="/kredit/bayar/store/{{ $customer->customer_id }}" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" name="amount_of_debt" autocomplete="off" value="{{ $customer->amount_of_debt }}" readonly id="total">
        </div>
        <div class="mb-3">
            <label for="amount_of_paid" class="form-label">Hutang Yang Dibayar</label>
            <input type="number" class="form-control" name="amount_of_paid" placeholder="Hutang yang dibayar..." autocomplete="off" id="bayar" oninput="sisaHutang(this.value)" min="0">
        </div>
        <div class="mb-3">
            <label for="remaining_debt" class="form-label">Sisa Hutang</label>
            <input type="number" class="form-control" name="remaining_debt" autocomplete="off" id="sisa" readonly value="{{ $customer->amount_of_debt }}" min="0">
        </div>
        <div class="mb-3">
            <label class="form-label" for="change">Kembalian</label>
            <input type="number" class="form-control" autocomplete="off" id="kembali" name="change" readonly value="0" min="0">
        </div>
